...
export default function TeamManagement() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-10">
      <h1 className="font-display text-2xl text-ink">Your team</h1>
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-3 rounded border border-line bg-white/60 p-5">
        <div className="grid grid-cols-2 gap-2 rounded border border-line p-1 text-sm w-fit">
          {["bidder", "writer"].map((r) => (
            <button
              type="button"
              key={r}
              ...
              className={`rounded px-4 py-1.5 capitalize transition ${
                form.role === r ? "bg-ink text-paper" : "text-charcoal/70 hover:text-ink"
              }`}
            >
              {r}
            </button>
      ...
      <h2 className="mt-10 font-display text-lg text-ink">Bidders</h2>
      ...
      <h2 className="mt-8 font-display text-lg text-ink">Writers</h2>
      <div className="mt-4 space-y-2">
