  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-10">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-display text-2xl text-ink">Business overview</h1>
          <p className="mt-1 text-sm text-charcoal/60">Every order across your whole team.</p>
        </div>
      ...
      <h2 className="mt-10 font-display text-lg text-ink">All orders</h2>
      <div className="mt-4 space-y-3">
        {data.orders.length === 0 && <p className="text-sm text-charcoal/60">No orders yet.</p>}
        {data.orders.map((o) => (
          <div key={o.id}>
            <OrderCard
              order={o}
